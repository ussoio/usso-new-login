        ...
        <div className={cn("flex flex-col gap-6", className)} {...props}>
            <Card>
                <CardHeader className="text-center">
                    ...
                    <CardDescription>با حساب اپل یا گوگل خود وارد شوید</CardDescription>
                </CardHeader>
                <CardContent>
                    <form>
                        <FieldGroup>
            ...
            <FieldDescription className="px-6 text-center">
                با کلیک بر روی ادامه، با <a href="#">شرایط استفاده</a> و <a href="#">حریم خصوصی</a> ما موافقت می‌کنید.
            </FieldDescription>
        </div>
    );
}
