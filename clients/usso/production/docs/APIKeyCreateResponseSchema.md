...
**api_key_pattern** | **string** |  | [default to undefined]
...
**rate_limit** | **{ [key: string]: any; }** |  | [optional] [default to undefined]
**api_key** | **string** | The API key | [default to undefined]

## Example

```typescript
import { APIKeyCreateResponseSchema } from './api';

const instance: APIKeyCreateResponseSchema = {
    uid,
    created_at,
    updated_at,
    is_deleted,
